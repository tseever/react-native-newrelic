...
}},{key:'startInteraction',value:function startInteraction(

name){
RNNewRelic.startInteraction(name);
}},{key:'stopInteraction',value:function stopInteraction(

name){
RNNewRelic.stopInteraction(name);
}},{key:'crashNow',value:function crashNow(

message){
RNNewRelic.crashNow(message);
}},{key:'recordBreadcrumb',value:function recordBreadcrumb(
