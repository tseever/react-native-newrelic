    ...
    _createClass(NewRelic, [
        {
            ...
            value: function _reportUncaughtExceptions() {
                var _this = this;
                var errorUtils = arguments.length > 0 && arguments[0] !== undefined
                    ? arguments[0]
                    : global.ErrorUtils;
            ...
            key: 'stopInteraction',
            value: function stopInteraction(name) {
                RNNewRelic.stopInteraction(name);
            }
        }, {
            key: 'crashNow',
            value: function crashNow(message) {
                RNNewRelic.crashNow(message);
            }
        }, {
            key: 'recordBreadcrumb',
            value: function recordBreadcrumb(name, args) {
